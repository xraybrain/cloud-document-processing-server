...
var getActivities = function (page, docId) { return __awaiter(void 0, void 0, void 0, function () {
    var feedback, pageSize, totalActivities, pager, _a, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, prisma.activity.count({
                        where: { documentId: docId },
                    })];
            case 2:
                totalActivities = _b.sent();
                pager = new Pagination_1.default(page, pageSize).getPager(totalActivities);
                feedback.page = page;
