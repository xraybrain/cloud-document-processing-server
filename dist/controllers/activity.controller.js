...
var getActivitiesController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var feedback, _a, page, docid;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                feedback = new Feedback_1.default();
                _a = req.query || 1, page = _a.page, docid = _a.docid;
                if (!docid) return [3 /*break*/, 2];
                return [4 /*yield*/, (0, activity_service_1.getActivities)(Number(page), Number(docid))];
            case 1:
                feedback = _b.sent();
                return [3 /*break*/, 3];
            case 2:
