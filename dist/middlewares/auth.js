...
var ensureAuthenticated = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authorization, feedback, verified;
    return __generator(this, function (_a) {
        ...
        if (!authorization) {
            ...
            return [2 /*return*/, res.status(401).send(feedback)];
        }
        authorization = authorization.split(" ")[1];
        verified = (0, jwt_utils_1.verifyToken)(authorization);
        if (verified.expired) {
            feedback.success = false;
